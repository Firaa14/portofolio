        ...
        >
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-4 flex-wrap">
              {[
                { icon: Linkedin, label: 'LinkedIn', href: 'https://www.linkedin.com/in/syafira-firdausi-nuzulla-4b7127315', color: 'from-blue-500/20 to-blue-600/10 hover:from-blue-500/30 hover:to-blue-600/20 text-blue-400' },
                { icon: Github, label: 'GitHub', href: 'https://github.com/Firaa14', color: 'from-slate-500/20 to-slate-600/10 hover:from-slate-500/30 hover:to-slate-600/20 text-slate-300' },
              ].map((social) => {
